...
const menuItems = [
  { name: 'Transaksi', path: '/admin/cabang/transaksi', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
  { name: 'Dashboard', path: '/admin/cabang/dashboard', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
]
    ...
    <div class="px-6 py-8 border-b border-white/10 flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="text-white/50 text-xs">Cabang</p>
        </div>
      </div>
    ...
    <div class="px-4 py-4 border-t border-white/10">
      <div class="flex items-center gap-3 px-4 py-3">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-white/40 text-xs">Cabang - {{ auth.user?.cabang_id || '' }}</p>
        </div>
      </div>
      <button
        @click="confirmLogout"
